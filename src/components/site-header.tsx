      ...
      <div className="mx-auto flex min-h-20 w-full max-w-7xl items-center justify-between gap-4 px-5 sm:px-8 lg:grid lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]">
        ...
        <div className="flex items-center gap-1.5 lg:justify-self-end">
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="absolute top-1 right-1 flex min-w-4 items-center justify-center rounded-full bg-foreground px-1 text-[10px] text-background tabular-nums leading-4"
            >
              {count}
            </span>
          </Link>
                ...
                <nav aria-label="Mobile navigation" className="flex flex-col">
                  {primaryNavItems.map((item) => (
                    ...
                    >
                      ...
                      <ArrowUpRight
                        aria-hidden="true"
                        className="size-5 text-muted-foreground transition-transform duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:translate-x-0.5 group-hover:-translate-y-0.5"
                      />
                    </Link>
                  ))}
                </nav>
